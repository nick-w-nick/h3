...
```
> [!TIP]
> The response will be sent once the promise has been resolved and will contain the resolved value.
...
You can register middleware to [app instance](/guide/app) using the `use` method:
