...
> [!TIP]
> Return any non-undefined value (`object`, `string`, `boolean`, etc.) to produce a [`200 OK`](https://developer.mozilla.org/en-US/docs/Web/HTTP/Status/200) status response.
