...
> [!TIP]
> Return any non-undefined value (see [Response Types](2.event-handler.md#response-types)) to produce a [`200 OK`](https://developer.mozilla.org/en-US/docs/Web/HTTP/Status/200) status response.
